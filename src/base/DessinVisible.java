...
public class DessinVisible extends Dessin {
    ...
    private void repaint() { // La jolie boucle de message (normalement...)
	panel.repaint() ;
    }
...
/**
 * Méthode pour attendre le clic "option 4"
 * + On dessine un point
 */
...
/**
 * Méthodes pour récuperer la latitude et la longitude du point cliqué
 * long1 et lat1  === > intialisé à 0,0   Points d'origine Haut gauche si ça marche
 * comme les fênetres windows
 */
